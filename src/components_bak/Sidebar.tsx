...
export const Sidebar: React.FC<SidebarProps> = ({ currentView, onViewChange }) => {
  ...
  return (
    <aside className="w-full md:w-64 bg-white dark:bg-slate-900 border-b md:border-b-0 md:border-r border-slate-200 dark:border-slate-800 flex flex-col shrink-0 transition-colors">
      {/* Branding Header */}
      <div className="p-6 border-b border-slate-100 dark:border-slate-800 flex items-center justify-between gap-2.5">
        <div className="flex items-center gap-2.5">
          <div className="p-2 bg-indigo-50 dark:bg-indigo-500/10 text-indigo-600 dark:text-indigo-400 rounded-lg">
            <DollarSign className="w-6 h-6 stroke-[2.5]" />
          </div>
          <div>
            <h1 className="font-bold text-slate-900 dark:text-white tracking-tight text-xl flex items-center gap-1">
